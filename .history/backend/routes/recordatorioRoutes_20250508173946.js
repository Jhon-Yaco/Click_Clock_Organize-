...
router.delete('/recordatorios/:id', recordatorioController.eliminarRecordatorio); // ✅ Referencia correcta
router.delete('/recordatorios/usuario', recordatorioController.eliminarTodosPorUsuario); // ✅ Sin conflicto
