document.addEventListener('DOMContentLoaded', function () {
    ...
    function eliminarRecordatorio(recordatorioId) {
        console.log(`🗑️ Intentando eliminar recordatorio con ID: ${recordatorioId}`); // 🔎 Depuración en consola
    ...
    // ✅ Ahora aseguramos que la función existe ANTES de ser llamada
    function renderizarListaRecordatorios() {
        const lista = document.getElementById('lista-recordatorios');
        lista.innerHTML = '';
        ...
        document.querySelectorAll('.btn-eliminar').forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                console.log(`🗑️ Intentando eliminar recordatorio con ID: ${recordatorioId}`); // 🔎 Verificar ID
                eliminarRecordatorio(recordatorioId); // ✅ Ahora la función sí existe
            });
        });
