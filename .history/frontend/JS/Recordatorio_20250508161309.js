document.addEventListener('DOMContentLoaded', function () {
    ...
    function eliminarRecordatorio(recordatorio) {
        ...
        .then(data => {
            ...
            recordatorios = recordatorios.filter(r => r.titulo !== recordatorio.titulo);
            renderizarListaRecordatorios(); // ✅ Refrescar interfaz después de eliminar
        })
    ...
    function eliminarTodosLosRecordatorios() {
        if (confirm("🚮 ¿Eliminar todos los recordatorios?")) {
            ...
            .then(data => {
                ...
                recordatorios = [];
                renderizarListaRecordatorios(); // ✅ Vaciar lista en la interfaz
            })
